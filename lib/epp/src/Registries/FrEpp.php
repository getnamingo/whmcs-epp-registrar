...
class FrEpp extends Epp
{
    protected function addLoginExtensions(\XMLWriter $xml): void
    {
        ...
        $xml->writeElement('extURI', 'http://www.afnic.fr/xml/epp/frnic-2.0');
        $xml->writeElement('extURI', 'urn:ietf:params:xml:ns:secDNS-1.1');
        $xml->writeElement('extURI', 'urn:ietf:params:xml:ns:launch-1.0');
    ...
    public function contactCreate($params = array())
    {
        ...
        try {
            ...
            $from[] = '/{{ firstname }}/';
            $to[] = htmlspecialchars($params['firstname']);
            $from[] = '/{{ lastname }}/';
            $to[] = htmlspecialchars($params['lastname']);
            $from[] = '/{{ org }}/';
      ...
      <contact:create
       xmlns:contact="urn:ietf:params:xml:ns:contact-1.0">
        ...
        <contact:postalInfo type="loc">
          <contact:name>{{ lastname }}</contact:name>
                   ...
                   <frnic:ext xmlns:frnic="http://www.afnic.fr/xml/epp/frnic-2.0">
                      <frnic:transfer>
                         <frnic:domain keepDS="1">
                            ...
                            <frnic:contact type="tech">{{ tech }}</frnic:contact>
                         </frnic:domain>
                      </frnic:transfer>
                   </frnic:ext>
                </extension>
